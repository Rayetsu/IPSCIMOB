    ...
    public static class Seed
    {
        ...
        public static void Initialize(ApplicationDbContext _context)
        {
            ...
            _context.InformacaoGeral.Add(new InformacaoGeral
            {
                ...
                Descricao = "<div class=\"center-justified\"><p></p><p>O Centro para a Internacionalização e Mobilidade do Instituto Politécnico de Setúbal (CIMOB-IPS) é uma estrutura de coordenação e apoio às atividades que visam a prossecução de políticas orientadas para a progressiva internacionalização do IPS. A finalidade é gerir e aprofundar a vertente internacional do IPS, concretizando estratégias de desenvolvimento de programas, projetos e atividades de carácter formativo de âmbito internacional (comunitário e extracomunitário), incremento da mobilidade de estudantes, docentes e não docentes e a captação de estudantes estrangeiros.</p><p></p><p>O CIMOB-IPS tem a superintendência da Vice- Presidente, Professora Fernanda Pestana, por delegação do Presidente do IPS. É constituído por uma equipa técnica, responsável pela gestão dos programas, e por uma equipa de coordenadores da mobilidade, responsável pelo reconhecimento académico. Existe um coordenador da mobilidade por cada Escola Superior que é nomeado pelo respetivo Diretor da Escola.</p>"
            });

            _context.InformacaoGeral.Add(new InformacaoGeral
            {
                Titulo = "Bolsas de Estudo",
                Descricao = "<div class=\"center-justified\"><p></p><p> As bolsas de mobilidade Erasmus são atribuídas anualmente pela <a href =\"https://erasmusmais.pt/\" target=\"_blank\"> Agência Nacional ERASMUS+ Educação e Formação (ANE+)</a>.</p><p></p><p> Os alunos interessados podem candidatar-se à obtenção de uma bolsa de mobilidade.Existe, contudo, a possibilidade do estudante ir em mobilidade sem bolsa caso tenhamos mais candidatos do que bolsas atribuídas.</p><p></p><p> As bolsas de mobilidade Erasmus destinam-se a auxiliar nas despesas de viagem e de subsistência(alojamento e alimentação), sendo apenas uma ajuda para fazer face à diferença do custo de nível de vida entre o país de origem e de destino. A atribuição da bolsa de mobilidades segue os mesmos critérios que a seleção dos candidatos.</p><p></p><p> Estudantes que pretendam prolongar o seu período de estudos terão a atribuição de bolsa complementar condicionada à verba existente.</p><p></p><p> Consulte aqui os valores das <a href=\"https://www.ips.pt/ips_si/web_gessi_docs.download_file?p_name=F822326484/Tabela_Bolsas_2017_035338.pdf\" target=\"_blank\"> Bolsas de Mobilidade para 2017-2018 (PDF | 98KB)</a>.</p><p></p><p> Ainda não recebemos a tabela de bolsas para 2018/2019 por parte da ANE+ em virtude de ainda estar a decorrer o processo de candidatura.</p><p></p><p> O pagamento das bolsas é feito da seguinte forma:</p><p></p><p>             - 90 % até 30 dias após a assinatura do contrato por ambos os outorgantes - antes da partida do estudante;</p><p></p><p>             - 10 % até 30 dias após a entrega da Carta de Confirmação, submissão do Relatório Final na plataforma eletrónica da Agência Nacional ERASMUS+ Educação e Formação, bem como a regularização de documentos que estejam em falta - aquando do regresso do estudante.</p><p></p><p>A gestão da verba atribuída é da inteira responsabilidade do/a estudante.</p>"
            });
            ...
            _context.ProgramaModel.Add(new ProgramaModel
            {
                ...
                Descricao = "<div class=\"center-justified\"><p>No âmbito do Ensino Superior, a Ação-Chave 1 – Mobilidade Individual, do Programa ERASMUS+, oferece oportunidades a docentes e não docentes de instituições de ensino superior (IES), bem como a pessoal de organizações da sociedade civil, de participarem numa experiência noutro país europeu. </p><p>Consulte a lista de <a href=\"http://www.ips.pt/ips_si/web_gessi_docs.download_file?p_name=F-203592363/Instituicoes_Parceiras_Nov_2017.pdf\" target=\"_blank\" >acordos bilaterais (PDF| 257KB)</a> existentes para missões de ensino.</p> </div>",
                ProgramaAtual = false,
